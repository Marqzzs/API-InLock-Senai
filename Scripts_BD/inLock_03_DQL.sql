...
Select J.IdJogo, J.Nome, J.Descricao, J.DataLancamento, J.Valor, J.IdEstudio, E.Nome AS NomeEstudio FROM Jogo J INNER JOIN Estudio E ON J.IdEstudio = E.IdEstudio
